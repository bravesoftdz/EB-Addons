    ...
    public static class _W
    {
        ...
        static _W()
        {
            ...
            if (enemies.Any(o => o.ChampionName.Equals("Kalista")))
                RoninTune.Menus.MiscMenu.Add("Oathsworn", new CheckBox("Block Oathsworn Knockup (Kalista R)", true));
            ...
            foreach (var unit in enemies)
            {
                ...
                foreach (var spell in _W.BlockedSpells[unit.ChampionName])
                {
                    ...
                    RoninTune.Menus.MiscMenu.Add(unit.ChampionName + spell.MenuName, new CheckBox(unit.ChampionName + " - " + spell.DisplayName, true));
                }
            }
        ...
        {           
            ...
            {           
                ...
                {
                    var item = RoninTune.Menus.MiscMenu[enemy.ChampionName + spell.MenuName];
