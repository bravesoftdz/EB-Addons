...
namespace RoninKassadin
{
    internal class Menus
    {
        ...
        public static void CreateMenu()
        {
            ...
            ComboMenu.CreateCheckBox(" - Use W Always", "wUse", false);
            ComboMenu.CreateCheckBox(" - Use W Only in Enemy Range", "wrUse", true);
            ComboMenu.AddLabel("E Spells");
            ComboMenu.CreateCheckBox(" - Use E Always", "eUse", false);
            ComboMenu.CreateCheckBox(" - Use E Only in Enemy Position", "erUse", true);
            ...
            LaneClearMenu.CreateSlider("Mana must be lower than [{0}%] to use LaneClear spells", "manaSlider", 50);
            LaneClearMenu.AddLabel("▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬");

            LasthitMenu.AddGroupLabel("Lasthit");
            LasthitMenu.AddLabel("▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬");
            LasthitMenu.CreateCheckBox(" - Use Q", "qUse", false);
            LasthitMenu.CreateCheckBox(" - Use W", "wUse", false);
